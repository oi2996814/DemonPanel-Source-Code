...
namespace KeyAuth
{
    public class api
    {
        ...
        public void UpdateInjects()
        {
            int b = Convert.ToInt32(var("TotalInjects"));
            b = b + 1;
            webhook("XhtDRrE797", b.ToString());
            int i = Convert.ToInt32(getvar("TotalInjects"));
            i = i + 1;
            setvar("TotalInjects", i.ToString());
